...
class PickupData(models.Model):
    ...
    PickLocations = [("Kozhikode", "Kozhikode")]

    Pickup_time = models.TimeField()
    pickup_date = models.DateField()
    dropoff_date = models.DateField()
    mobile_number = models.BigIntegerField()
    PickLocation = models.CharField(max_length=20, choices=PickLocations, default="")
    ...
    totalAMT = models.CharField(max_length=30, null=True, blank=True)
...
class Payment(models.Model):
    ...
    user = models.ForeignKey(
        Registerinfo, on_delete=models.CASCADE, null=True, blank=True
    )
    booking = models.ForeignKey(
        PickupData, on_delete=models.CASCADE, null=True, blank=True
    )
