...
urlpatterns = [
    ...
    path("priceSorting/<str:sort_type>/", views.priceSorting, name="priceSorting"),
    path("payment/<int:id>/", views.payment, name="payment"),
    path("success/", views.success, name="success"),
    path(
        "add_to_wishlist/<int:car_id>/", views.add_to_wishlist, name="add_to_wishlist"
    ),
    path(
        "remove_from_wishlist/<int:car_id>/",
